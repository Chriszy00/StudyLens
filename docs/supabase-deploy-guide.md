...
## Project Details
- **Project Reference**: `zpepkrkpvujqrhnktbfe`
...
npx supabase functions deploy --project-ref zpepkrkpvujqrhnktbfe --no-verify-jwt
```

### Deploy Specific Function
```powershell
# Deploy only the process-document function
npx supabase functions deploy process-document --project-ref zpepkrkpvujqrhnktbfe --no-verify-jwt
```
...
```powershell
npx supabase functions logs process-document --project-ref zpepkrkpvujqrhnktbfe
```
...
cd "d:\OneDrive - eduCLaaS Pte Ltd\eduClaas Folder\M20 CAI\Code\Dev-ver1\study-library-dashboard"
...
npx supabase functions logs process-document --project-ref zpepkrkpvujqrhnktbfe --tail
```
